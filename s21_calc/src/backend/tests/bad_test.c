...
START_TEST(sign_end_1) {
  ...
  elif (type_sign == 1) { snprintf(string, sizeof(string), "+"); }
  elif (type_sign == 2) { snprintf(string, sizeof(string), "*"); }
  elif (type_sign == 3) { snprintf(string, sizeof(string), "/"); }
  elif (type_sign == 4) { snprintf(string, sizeof(string), "^"); }
  elif (type_sign == 5) { snprintf(string, sizeof(string), "mod"); }
  else {
...
START_TEST(sign_end_2) {
  ...
  char tmp_string[256];
  snprintf(tmp_string, sizeof(tmp_string), "%Lf",
           get_random(-RAND_MAX / 2, RAND_MAX / 2));
