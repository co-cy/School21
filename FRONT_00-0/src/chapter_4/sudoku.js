...
console.log(solve("29-5----77-----4----4738-129-2--3-648---5--7-5---672--3-9--4--5----8-7---87--51-9"));
console.log(solve("-8--2-----4-5--32--2-3-9-466---9---4---64-5-1134-5-7--36---4--24-723-6-----7--45-"));
...
console.log(solve("-3-5--8-45-42---1---8--9---79-8-61-3-----54---5------78-----7-2---7-46--61-3--5--"));
console.log(solve("-96-4---11---6---45-481-39---795--43-3--8----4-5-23-18-1-63--59-59-7-83---359---7"));
console.log(solve("----754----------8-8-19----3----1-6--------34----6817-2-4---6-39------2-53-2-----"));
console.log(solve("3---------5-7-3--8----28-7-7------43-----------39-41-54--3--8--1---4----968---2--"));
console.log(solve("3-26-9--55--73----------9-----94----------1-9----57-6---85----6--------3-19-82-4-"));
console.log(solve("-2-5----48-5--------48-9-2------5-73-9-----6-25-9------3-6-18--------4-71----4-9-"));
console.log(solve("--7--8------2---6-65--79----7----3-5-83---67-2-1----8----71--38-2---5------4--2--"));
console.log(solve("----------2-65-------18--4--9----6-4-3---57-------------------73------9----------"));
console.log(solve("---------------------------------------------------------------------------------"));
