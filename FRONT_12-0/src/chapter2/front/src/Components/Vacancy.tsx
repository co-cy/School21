...
export default function Vacancy() {
    ...
    const [vacancy, setVacancy] = useState<IVacancy>({title: "", description: "", english: "", grade: -1});
    ...
    return (
        <div style={{color: "#fff", display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gridTemplateRows: "repeat(5, 1fr)"}}>
            ...
            <div style={{gridColumn: "4/4", alignSelf: "center"}}><span className="vacancy">Grade: {vacancy.grade>=0? vacancy.grade: ""}</span></div>
